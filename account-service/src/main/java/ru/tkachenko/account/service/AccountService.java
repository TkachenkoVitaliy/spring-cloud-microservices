package ru.tkachenko.account.service;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import ru.tkachenko.account.entity.Account;
import ru.tkachenko.account.exception.AccountNotFoundException;
import ru.tkachenko.account.repository.AccountRepository;
...
public class AccountService {
    ...
    public Account getAccountById(Long accountId) {
        return accountRepository.findById(accountId).orElseThrow(() -> new AccountNotFoundException("Unable to find " +
    ...
    public Account updateAccount(Long accountId, String name, String email, String phone, List<Long> bills) {
        ...
        //TODO Account account = getAccountById(accountId); вместо текущего варианта
